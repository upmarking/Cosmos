...
sealed class Screen(val route: String) {
    ...
    object PostEvent : Screen("post_event?eventId={eventId}") {
        fun createRoute(eventId: String? = null) = if (!eventId.isNullOrBlank() && eventId != "{eventId}" && eventId != "null") "post_event?eventId=$eventId" else "post_event"
    }
    ...
    object OrbitPostDetail : Screen("orbit_post_detail/{circleId}/{postId}") {
        fun createRoute(circleId: String, postId: String) = "orbit_post_detail/$circleId/$postId"
    }
    ...
    object NetworkRelations : Screen("network_relations/{initialTab}") {
        fun createRoute(initialTab: String) = "network_relations/$initialTab"
    }
