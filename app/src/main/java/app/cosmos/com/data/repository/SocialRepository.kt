...
interface SocialRepository {
    ...
    suspend fun uploadPostImage(postId: String, bytes: ByteArray): Result<String>
}
...
class FirestoreSocialRepository(
    ...
    override suspend fun createSocialPost(
        ...
        val postDoc = mutableMapOf(
            ...
            "isLinkedInConnected" to isLinkedInConnected
        )
        if (imageUrl != null) {
    ...
    override suspend fun addPostReply(postId: String, reply: SocialPostReply): Result<Unit> = runCatching {
        val replyDoc = mapOf(
            ...
            "timestamp" to FieldValue.serverTimestamp(),
            "isLinkedInConnected" to reply.isLinkedInConnected
        )
    ...
    override suspend fun uploadPostImage(postId: String, bytes: ByteArray): Result<String> = runCatching {
